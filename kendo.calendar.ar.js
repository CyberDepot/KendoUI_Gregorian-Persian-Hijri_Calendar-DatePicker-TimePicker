...
(function (f, define) {
    ...
    (function ($, undefined) {
        ...
        var CalendarHijri = Widget.extend({
            ...
            _validateValue: function (value) {
                ...
                if (value === null) {
                    that._current = new HijriDate(that._current.getFullYear(), that._current.getMonth(), that._current.getDate());
                }
            ...
            _nextNavigatable: function (currentValue, value) {
                var that = this, disabled = true, view = that._view, min = that.options.min, max = that.options.max, isDisabled = that.options.disableDates, navigatableDate = new HijriDate(currentValue.getTime());
            ...
            _click: function (link) {
                var that = this, options = that.options, currentValue = new HijriDate(+that._current), value = that._toDateObject(link);
                adjustDST(value, 0);
                if (that._view.name == 'month' && that.options.disableDates(value)) {
                    value = that._value;
                }
